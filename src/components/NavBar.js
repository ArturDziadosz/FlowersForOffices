    ...
    return (
      <>
        <nav className={this.state.hamburgerMenuOpen ? "nav nav--hamburger" : "nav"}
             style={this.state.topPosition ? {top: "120px"} : {top: "58px"}}>
          <ul className={"nav__list"}>
            <li className={this.state.topPosition ? "nav__list__elem" : "nav__list__elem nav__list__elem--short"}><Link
              to={"header"} spy={true} smooth={true} duration={1000} offset={-250}
            ...
            <li className={this.state.topPosition ? "nav__list__elem" : "nav__list__elem nav__list__elem--short"}><Link
              to={"realization"} spy={true} smooth={true} duration={1000} offset={-80}
              onClick={this.handleCloseHamburgerMenu}>REALIZACJE</Link></li>
            <li className={this.state.topPosition ? "nav__list__elem" : "nav__list__elem nav__list__elem--short"}><Link
              to={"contact"} spy={true} smooth={true} duration={1000}
              onClick={this.handleCloseHamburgerMenu}>KONTAKT</Link></li>
          </ul>
        </nav>
      </>
    )
